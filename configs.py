...
def get_spec_info(cpu2006_run_dir,buffer,elf_suffix):
    ...
    return {
        ...
        "gcc_cpdecl": (
            [
                f"{buffer}/gcc" + elf_suffix,
                f"{cpu2006_run_dir}/gcc/cp-decl.i"
            ],
        ...
        "gcc_scilab": (
            [
                f"{buffer}/gcc" + elf_suffix,
                f"{cpu2006_run_dir}/gcc/scilab.i"
            ],
            [ "scilab.i", "-o", "scilab.s" ],
            [ "int", "ref" ]
        ),
        "gcc_typeck": (
            [
                f"{buffer}/gcc" + elf_suffix,
                f"{cpu2006_run_dir}/gcc/c-typeck.i"
            ],
        ...
        "libquantum": (
            [
                f"{buffer}/libquantum" + elf_suffix
            ],
            [ "1397", "8" ],
            [ "int", "ref" ]
        ),
        ...
        "povray": (
            [
                f"{buffer}/povray" + elf_suffix,
                f"dir . {cpu2006_run_dir}/povray"
            ],
        ...
        "sjeng": (
            [
                f"{buffer}/sjeng" + elf_suffix,
                f"{cpu2006_run_dir}/sjeng/ref.txt"
            ],
            [ "ref.txt" ],
            [ "int", "ref" ]
        ),
        ...
        "tonto": (
            [
                f"{buffer}/tonto" + elf_suffix,
                f"{cpu2006_run_dir}/tonto/stdin"
            ],
            [],
            [ "fp", "ref" ]
        ),
        "wrf": (
            [
                f"{buffer}/wrf" + elf_suffix,
                f"dir . {cpu2006_run_dir}/wrf"
            ],
            [],
            [ "fp", "ref" ]
        ),
